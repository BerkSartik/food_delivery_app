...
class LocaleManager {
  ...
  Future<void> setStringListValue(PreferencesKeys key, List<String> value) async {
  ...
  List<String> getStringListValue(PreferencesKeys key) => _preferences?.getStringList(key.toString()) ?? [];
